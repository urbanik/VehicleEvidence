...
public class Block2<R extends Record<R>> {
    ...
    public Block2(R typeRecord) {
        this.size = DEFAULT_CLUSTER_SIZE; // defaultna velkost clustra pri citani
        ...
        this.spaceLeft = DEFAULT_CLUSTER_SIZE - additionalSpace - this.numberOfRecords*this.recordSize;
